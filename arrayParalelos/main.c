...
void ordenarAlumnoLeg(int[], int[], char[], int[], int[], float[], int tam);
int main()
{
   ...
   /* for( int i=0; i < TAM; i++){
    ...
    ordenarAlumnoLeg(legajos, edades, sexos, notasP1, notasP2, promedios, TAM );
...
void ordenarAlumnoLeg(int leg[], int age[], char sex[], int n1[], int n2[], float prom[], int tam){
    int auxInt;
    char auxChar;
    float auxFloat;
