...
int hardcodearAlumnos(eAlumno alumnos[], int tam, int cantidad)
{
    ...
    {
        { 20000, "Juan", 21, 'm', 2, 10, 6,{12, 5, 2018},     1001, 0},
        { 20001, "Ana", 22, 'f', 6, 8, 7,{21, 5, 2013},       1002, 0},
        { 20002, "Alicia", 20, 'f', 5, 4, 4.5,{4, 8, 2014},   1000, 0},
        { 20003, "Miguel", 23, 'm', 6, 6, 6,{20, 3, 2015},    1000, 0},
        { 20004, "Gaston", 20, 'm', 2, 4, 3,{23, 8, 2019},    1001, 0},
        { 20005, "Amalia", 21, 'f', 2, 8, 4,{11, 2, 2011},    1002, 0},
        { 20006, "Sofia", 27, 'f', 10, 10, 10,{9, 10, 2018},  1002, 0},
        { 20007, "Diego", 20, 'm', 9, 8, 8.5,{4, 5, 2018},    1001, 0},
